...
[www.xhhuanglab.cn/tool/OutcrossSeq.html](www.xhhuanglab.cn/tool/OutcrossSeq.html) 
...
| ------------- |------------- | 
| `100000` | window size |
| `1000` | min marker number in each window |
...
| ------------- |------------- |
| `5` |  chromosome |
| `demo_autopolyploid` |the input file of the vcf file |
| `Parent1` | the id of parent1 in vcf file |
| `Parent2` |the id of parent2 in vcf file  |
...
Manpage [supplementary note]() provides more detailed descriptions and tips of OutcrossSeq.
