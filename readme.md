...
The ditels of Docker container can be found in [supplementary note](https://github.com/xhhuanglab/OutcrossSeq/blob/master/Supplemental%20note.pdf).
``` 
...
Parameter information of run together, please see [supplementary note](https://github.com/xhhuanglab/OutcrossSeq/blob/master/Supplemental%20note.pdf).
```	
...
```
git clone www.xhhuanglab.cn/tool/OutcrossSeq.html
...
Manpage [supplementary note](https://github.com/xhhuanglab/OutcrossSeq/blob/master/Supplemental%20note.pdf) provides more detailed descriptions and tips of OutcrossSeq.
